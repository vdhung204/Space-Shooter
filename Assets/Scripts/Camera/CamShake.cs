using UnityEngine;
    ...
    /*private void Update()
    {
        ...
        {
            // Lerp position back to zero
            transform.localPosition = Vector3.Lerp(transform.localPosition, Vector3.zero, Time.deltaTime * traumaDecay);

            // Smoothly return rotation to the identity quaternion
            transform.localRotation = Quaternion.Lerp(transform.localRotation, Quaternion.identity, Time.deltaTime * traumaDecay);
        }
    }*/
